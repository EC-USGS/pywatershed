...
!***********************************************************************
 ...
 9006 FORMAT ('(I4, 2(''-'',I2.2),',I0,'('','',G0))')  !jdh modified F0.3 to G9
 9007 FORMAT ('(I4, 2(''-'',I2.2),',I0,'('','',G0))')  !jdh modified F0.2 to G9
 9008 FORMAT ('(I4,', I0,'('','',F0.4))')
 9009 FORMAT ('(I4,', I0,'('','',F0.3))')
 9010 FORMAT ('(I4,', I0,'('','',F0.2))')
 9011 FORMAT ('(I4,', I0,'('','',F0.5))')
 9012 FORMAT ('(I4, 2(''-'',I2.2),',I0,'('','',G0))')  !jdh modified F0.5 to G9
