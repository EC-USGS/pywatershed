...
from pynhm.groundwater.PRMSGroundwater_better import PRMSGroundwaterBetter
...
class TestPRMSGroundwaterDomain:
    def test_init(self, domain):
        ...
        input_variables = {}
        for key in PRMSGroundwaterBetter.get_input_variables():
            output_pth = output_files[key]
            nc_pth = output_pth.with_suffix(".nc")
            input_variables[key] = nc_pth

        gw = PRMSGroundwaterBetter(prms_params, atm, **input_variables)
        ...
        output_compare = {}
        for key in PRMSGroundwaterBetter.get_output_variables():
            output_pth = output_files[key]
