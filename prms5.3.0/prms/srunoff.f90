...
!   Local Variables
      ...
      REAL, SAVE, ALLOCATABLE :: Infil_ag(:)
...
!***********************************************************************
     ...
     &    Dprst_flag, Cascade_flag, Sroff_flag, Call_cascade, PRMS4_flag, Frozen_flag, AG_flag
      USE PRMS_SRUNOFF
...
!***********************************************************************
     ...
     &    Pk_depth, Snowcov_area, Snow_evap, Snowmelt, Glacrb_melt
